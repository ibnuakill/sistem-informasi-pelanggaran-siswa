...
session_start();
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM JENIS_PELANGGARAN WHERE id_jenis = '$id'");
...
<head>
  ...
  <title>SIPS &rsaquo; Edit Jenis Pelanggaran</title>
      ...
      <div class="main-content">
        <section class="section">
          <h1 class="section-header">
            <div>Edit Jenis Pelanggaran</div>
          </h1>
          <div class="card">
              ...
              <div class="card-body">
                <form method="POST" class="needs-validation">
                  <div class="form-group">
                    <label>ID</label>
                    <h5><?php echo $data['id_jenis']?></h5>
                  </div>
                  <div class="form-group">
                    <label>Jenis Pelanggaran</label>
                    <input value="<?php echo $data['jenis_pelanggaran']?>" type="text" class="form-control" name="jenis_pelanggaran" tabindex="1" required>
                  </div>
                  <div class="form-group">
                    <label>Poin Pelanggaran</label>
                    <input value="<?php echo $data['poin']?>" type="number" class="form-control" name="poin" tabindex="1" required>
                  </div>
                  <br>
                  <div class="form-group">
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $edit_data = mysqli_query($koneksi, "UPDATE JENIS_PELANGGARAN SET jenis_pelanggaran='$jenis_pelanggaran', poin='$poin' WHERE id_jenis='$id_jenis'");
