...
<head>
  ...
  <title>SIPS &rsaquo; Edit Data Siswa</title>
              ...
              <div class="card-body">
                <form method="POST" class="needs-validation">
                  <div class="form-group">
                    <label>NIS</label>
                    <h5><?php echo $data['NIS']?></h5>
                  </div>
                  <div class="form-group">
                    <label>Nama Siswa</label>
                    <input type="text" value="<?php echo $data['nama_siswa']?>" class="form-control" name="nama_siswa" tabindex="1" required>
                  </div>
                  <div class="form-group">
                    <label>Kelas</label>
                  ...
                  <div class="form-group">
                    <label>Alamat</label>
                    <input value="<?php echo $data['alamat']?>" type="text" class="form-control" name="alamat" tabindex="1" required>
                  </div>
                  <div class="form-group">
