...
session_start();
$query = mysqli_query($koneksi,"SELECT * FROM PELANGGARAN_SISWA");
?>
...
<head>
  ...
  <title>SIPS &rsaquo; Pelanggaran Siswa</title>
      ...
      <div class="main-content">
        <section class="section">
          <h1 class="section-header">
            <div>Pelanggaran Siswa</div>
          </h1>
          <a href="tambah_pelanggaran.php" class="btn btn-blue col-sm-12 col-lg-3" style="margin-bottom: 25px">
