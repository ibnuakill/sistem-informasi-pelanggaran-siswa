...
<head>
  ...
  <title>SIPS &rsaquo; Edit Data Jurusan</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active" data-toggle="tooltip" data-placement="right" data-original-title="Data Jurusan">
              ...
              <div class="card-body">
                <form method="POST" class="needs-validation">
                  <div class="form-group">
                    <label>ID</label>
                    <h5><?php echo $data['id_jurusan']?></h5>
                  </div>
                  <div class="form-group">
                    <label>Nama Jurusan</label>
                    <input value="<?php echo $data['nama_jurusan']?>" type="text" class="form-control" name="nama_jurusan" tabindex="1" required>
                  </div>
                  <div class="form-group">
                    <label>Keterangan</label>
                    <input value="<?php echo $data['keterangan']?>" type="text" class="form-control" name="keterangan" tabindex="1" required>
                  </div>
                  <br>
                  <div class="form-group">
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $edit_data = mysqli_query($koneksi, "UPDATE JURUSAN SET nama_jurusan='$nama_jurusan', keterangan='$keterangan' WHERE id_jurusan='$id_jurusan'");
