...
session_start();
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM USER WHERE id_akun = '$id'");
...
<head>
  ...
  <title>SIPS &rsaquo; Edit Akun Pengguna</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active" data-toggle="tooltip" data-placement="right" data-original-title="Data Akun Pengguna">
              ...
              <div class="card-body">
                <form method="POST" class="needs-validation">
                  <div class="form-group">
                    <label>ID</label>
                    <h5><?php echo $data['id_akun']?></h5>
                  </div>
                  <div class="form-group">
                    <label>Nama Pengguna</label>
                    <input value="<?php echo $data['nama_pengguna']?>" type="text" class="form-control" name="nama_pengguna" tabindex="1" required>
                  </div>
                  <div class="form-group">
                    <label>Username</label>
                    <input value="<?php echo $data['username']?>" type="text" class="form-control" name="username" tabindex="1" required>
                  </div>
                  <div class="form-group">
                    <label>Password</label>
                    <input value="<?php echo $data['password']?>" type="text" class="form-control" name="password" tabindex="1" required>
                  </div>
                  <div class="form-group">
                    <label>Role</label>
                  ...
                  <div class="form-group">
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $edit_data = mysqli_query($koneksi, "UPDATE USER SET nama_pengguna='$nama_pengguna', username='$username', password='$password', role='$role' WHERE id_akun='$id_akun'");
