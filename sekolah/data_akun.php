...
<head>
  ...
  <title>SIPS &rsaquo; Manajemen Akun</title>
    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        <section class="section">
          ...
          <a href="tambah_akun.php" class="btn btn-blue col-sm-12 col-lg-3" style="margin-bottom: 25px">
                ...
                <table id="example" class="table table-striped table-bordered" width="100%">
                  ...
                  <tbody>
                    ...
                    while($data = mysqli_fetch_array($query)){
                      ...
                      echo "<td>
                      <a href='edit_akun.php?id=$id_akun' class='btn btn-sm btn-blue' style='margin: 5px'>
                      <span class='ion-android-create' aria-hidden='true'></span>
                      </a>
                      <a href='proses/hapus_akun.php?id=$id_akun' class='btn btn-sm btn-danger' style='margin: 5px'>
